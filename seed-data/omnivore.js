module.exports = {
  things: [
    {
      key: 'omnivore:highlight:foo-bar-84Z',
      type: 'omnivore:highlight',
      entity: {
        type: 'HIGHLIGHT',
        userId: '81f4256e-436d-11ee-afdb-f3959092db7f',
        id: 'd12c33c9-80d1-4cbb-b484-2223482d9661',
        shortId: '1mjaZHcq',
        articleId: '4fb90672-feba-448d-9b45-81db4bdf25cc',
        patch:
          '@@ -1319,16 +1319,36 @@\n' +
          ' dustry.%C2%A0\n' +
          ...
          '  Despite\n',
        quote: 'The smart home remains fragmented.',
        prefix: '',
        suffix:
        ...
        annotation: 'No kidding...',
        highlightPositionPercent: 8.878263686426951,
        html: 'The smart home remains fragmented.',
        updatedAt: '2023-08-27T06:41:31.927Z',
        createdAt: '2023-08-27T06:41:31.927Z',
        pageId: '4fb90672-feba-448d-9b45-81db4bdf25cc', // added on webhook ingest
        page: {
          // added on webhook ingest
          type: 'page',
          userId: '81f4256e-436d-11ee-afdb-f3959092db7f',
          id: '4fb90672-feba-448d-9b45-81db4bdf25cc',
          ...
          image: 'https://www.theverge.com/image/jpeg',
          publishedAt: '2023-08-26T12:00:00.000Z',
          readingProgressPercent: 0,
          readingProgressAnchorIndex: 0,
          state: 'SUCCEEDED',
          createdAt: '2023-08-27T06:36:04.726Z',
          savedAt: '2023-08-27T06:36:04.726Z',
          siteName: 'The Verge',
          language: 'English',
    ...
    },
    {
      ...
      entity: {
        type: 'label',
        userId: '81f4256e-436d-11ee-afdb-f3959092db7f',
        pageId: '4fb90672-feba-448d-9b45-81db4bdf25cc',
        id: '7cf72a66-44a3-11ee-8399-0fab87e77ebe',
        name: 'Favorite',
        color: '#CE88EF',
        description: null,
        createdAt: '2023-08-27T06:32:26.193Z',
        page: {
          // added on webhook ingest
          type: 'page',
          userId: '81f4256e-436d-11ee-afdb-f3959092db7f',
    ...
    },
    {
      ...
      entity: {
        annotation: 'This is a huge release with a bunch of helpful updates.',
        articleId: '7dfc1270-3a75-44e7-b764-d8a30ed1b460',
        createdAt: '2023-08-28T02:09:28.913Z',
        highlightPositionPercent: 0,
        html: 'ReadStream and WriteStream from <code data-omnivore-anchor-idx="13" class="hljs language-crmsh language-avrasm"><span data-omnivore-anchor-idx="14" class="hljs-keyword">node</span><span data-omnivore-anchor-idx="15" class="hljs-title">:tty</span></code> are implemented, and <code data-omnivore-anchor-idx="16" class="hljs language-asciidoc language-css"><span data-omnivore-anchor-idx="17" class="hljs-title">.setRawMode()</span></code> now works on <code data-omnivore-anchor-idx="18" class="hljs language-arduino language-livecodeserver"><span data-omnivore-anchor-idx="19" class="hljs-built_in">process</span>.<span data-omnivore-anchor-idx="20" class="hljs-built_in">stdin</span></code>, unblocking several interactive CLI tools. Plus Node.js compatibility updates, bug fixes, stability improvements.',
        id: '443c2167-0225-4723-854f-968c812b0a7f',
        page: {
          archivedAt: null,
          createdAt: '2023-08-28T00:40:39.016Z',
          description:
    ...
    },
    {
      ...
      entity: {
        annotation: 'There is hope!',
        articleId: '4d5c9bc5-3b55-4254-af34-888230a5cccd',
        createdAt: '2023-08-28T02:07:49.389Z',
        highlightPositionPercent: 2.706852272304314,
        html: 'Nature is clearly in the midst of reclaiming ground ceded to previous efforts at human expansion here.',
        id: 'c977ee3f-2b3c-4892-a070-2cfdf8422938',
        page: {
          archivedAt: null,
          author: 'Alex K.T. Martin',
          createdAt: '2023-08-28T00:38:17.054Z',
          description:
    ...
    },
    {
      ...
      entity: {
        archivedAt: null,
        createdAt: '2023-08-28T00:36:51.328Z',
        description:
        ...
        readingProgressAnchorIndex: 0,
        readingProgressPercent: 0,
        savedAt: '2023-08-28T00:36:51.328Z',
        siteIcon: 'https://joshcollinsworth.com/2020-icon.svg',
    ...
    },
    {
      ...
      entity: {
        color: '#7BE4FF',
        createdAt: '2023-08-27T23:22:53.413Z',
        description: null,
        id: 'a59aa60e-4530-11ee-9035-e7e8af6d461a',
        name: 'Favorite',
        page: {
          archivedAt: null,
          createdAt: '2023-08-28T00:36:51.328Z',
    ...
    },
    {
      ...
      entity: {
        archivedAt: null,
        createdAt: '2023-08-28T00:52:01.550Z',
        description: 'Relational Database, on the client.',
        hash: 'a4256577860f451a5b260c5a06d4afcf',
        id: '1df5f2ea-de7f-493c-b954-4f993849648c',
        language: 'English',
        pageType: 'WEBSITE',
        publishedAt: '1954-08-16T00:00:00.000Z',
        readingProgressAnchorIndex: 0,
        readingProgressPercent: 0,
        savedAt: '2023-08-28T00:52:01.550Z',
        siteIcon: 'https://www.instantdb.com/playful_sun.svg',
        siteName: 'instantdb.com',
        slug: 'datalog-in-javascript-18a39a04d8d',
        state: 'SUCCEEDED',
    ...
    },
    {
      ...
      entity: {
        archivedAt: null,
        author: 'admin',
        createdAt: '2023-08-28T00:40:57.740Z',
        description:
        ...
        hash: '473527a279acf503c20574c5067eb058',
        id: 'baa4de26-f6c4-4dd3-954b-bd34b5a05484',
        image: '',
        language: 'English',
        pageType: 'UNKNOWN',
        readingProgressAnchorIndex: 0,
        readingProgressPercent: 0,
        savedAt: '2023-08-28T00:40:57.740Z',
        siteName: 'drillyourownwell.com',
        slug: 'drillyourownwell-com-18a39962c8c',
        state: 'SUCCEEDED',
        title: 'drillyourownwell.com',
        type: 'page',
